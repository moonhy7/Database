...
CREATE TABLE `comment` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Comment_Notice1_idx` (`Notice_id`),
  KEY `fk_Comment_Member1_idx` (`Member_id`),
  CONSTRAINT `fk_Comment_Member1` FOREIGN KEY (`Member_id`) REFERENCES `member` (`id`),
  CONSTRAINT `fk_Comment_Notice1` FOREIGN KEY (`Notice_id`) REFERENCES `notice` (`id`)
...
CREATE TABLE `notice` (
  ...
  `Member_id` varchar(50) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Notice_Member_idx` (`Member_id`),
...
CREATE TABLE `role` (
  ...
  `Member_id` varchar(50) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Role_Member1_idx` (`Member_id`),
  CONSTRAINT `fk_Role_Member1` FOREIGN KEY (`Member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-15 17:10:25
